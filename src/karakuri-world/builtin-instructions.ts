...
export function buildKarakuriWorldModeInstructions(): string {
  return [
    ...
    '- `karakuri_world_conversation_speak`: respond during an active conversation with `message`',
    '- `karakuri_world_end_conversation`: end a conversation with a farewell `message`',
